...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-blue-500/30 overflow-x-hidden relative">
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-26 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
        ...
        <div className="animate-fade-in-up inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition-colors cursor-default mb-6 md:mb-8 backdrop-blur-md relative z-10">
        ...
        <p className="animate-fade-in-up delay-200 text-sm sm:text-base md:text-lg lg:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed px-2 relative z-10">
      ...
      <section className="py-16 md:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className="order-1 text-left">
            ...
            <div className="space-y-4 md:space-y-6 text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed text-left">
              <p>
          ...
          <div className="relative order-2 w-full max-w-md mx-auto lg:mx-0 lg:ml-auto">
            ...
            <div className="relative bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-2xl animate-float">
              {/* Terminal Header */}
              <div className="flex items-center gap-2 mb-5 md:mb-6 border-b border-white/5 pb-3 md:pb-4">
                ...
                <div className="ml-auto text-[9px] md:text-xs text-gray-500 font-mono tracking-wider">
                  origin_story.ts
                </div>
              </div>
              
              {/* Terminal Body */}
              <div className="space-y-2 md:space-y-3 font-mono text-[11px] md:text-sm">
                ...
                <div className="text-gray-400 pl-4 mb-3 md:mb-4 opacity-80">
      ...
      <section className="py-16 md:py-32 bg-[#050505] border-t border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
            {[
              ...
              <div key={idx} className="bg-[#0a0a0a] p-6 md:p-8 rounded-[20px] md:rounded-[24px] border border-white/5 hover:bg-[#111] hover:border-white/10 transition-all duration-300 group shadow-lg">
                <div className={`w-12 h-12 md:w-14 md:h-14 ${feature.bg} ${feature.color} border ${feature.border} rounded-xl md:rounded-2xl flex items-center justify-center mb-5 md:mb-6 group-hover:scale-110 transition-transform`}>
      ...
      <section className="py-16 md:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {/* Large Card */}
          <div className="md:col-span-2 bg-[#111]/80 backdrop-blur-xl border border-white/10 p-6 md:p-10 rounded-[24px] md:rounded-[32px] relative overflow-hidden group shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:border-blue-500/30 transition-colors">
            <div className="absolute top-0 right-0 w-48 h-48 md:w-64 md:h-64 bg-blue-600/10 rounded-full blur-[80px] pointer-events-none"></div>
            <div className="relative z-10">
              <Shield className="text-blue-400 mb-5 md:mb-6 w-8 h-8 md:w-9 md:h-9" />
              <h3 className="text-xl md:text-3xl font-bold text-white mb-3 md:mb-4">Radical Transparency</h3>
          ...
          {/* Tall Card */}
          <div className="md:row-span-2 bg-[#111]/80 backdrop-blur-xl border border-white/10 p-6 md:p-10 rounded-[24px] md:rounded-[32px] relative overflow-hidden group shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:border-purple-500/30 transition-colors flex flex-col justify-center">
            <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-purple-500 to-pink-500"></div>
            <div className="absolute top-0 left-0 w-48 h-48 md:w-64 md:h-64 bg-purple-600/10 rounded-full blur-[80px] pointer-events-none"></div>
            <div className="relative z-10">
                <Heart className="text-purple-400 mb-5 md:mb-6 w-8 h-8 md:w-9 md:h-9" />
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4">Empathy First</h3>
        ...
        <div className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-white/10 rounded-[32px] md:rounded-[40px] p-8 md:p-16 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-5 w-full sm:w-auto px-4 sm:px-0">
                    ...
                    <Link
                        href="/signup"
                        className="w-full sm:w-auto px-8 py-3.5 md:py-4 rounded-full bg-gradient-to-b from-white/10 to-transparent backdrop-blur-xl border border-white/10 text-white text-sm md:text-base font-medium transition-all duration-300 flex items-center justify-center gap-2 shadow-[0_8px_32px_rgba(0,0,0,0.2)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] hover:bg-white/10 hover:border-white/20 hover:shadow-[0_8px_32px_rgba(255,255,255,0.05)] hover:-translate-y-0.5"
                    >
                        Join the Community
                    </Link>
                </div>
